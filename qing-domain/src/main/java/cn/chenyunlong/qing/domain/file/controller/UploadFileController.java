...
public class UploadFileController {
    ...
    public JsonResult<Long> createUploadFile(@RequestBody UploadFileCreateRequest request) {
        UploadFileCreator creator = UploadFileMapper.INSTANCE.request2Dto(request);return JsonResult.success(uploadFileService.createUploadFile(creator));
    }
    ...
    public JsonResult<String> updateUploadFile(@RequestBody UploadFileUpdateRequest request) {
        UploadFileUpdater updater = UploadFileMapper.INSTANCE.request2Updater(request);uploadFileService.updateUploadFile(updater);
    ...
    public JsonResult<String> validUploadFile(@PathVariable Long id) {
        uploadFileService.validUploadFile(id);return JsonResult.success(CodeEnum.Success.getName());
    }
    ...
    public JsonResult<String> invalidUploadFile(@PathVariable Long id) {
        uploadFileService.invalidUploadFile(id);return JsonResult.success(CodeEnum.Success.getName());
    }
    ...
    public JsonResult<UploadFileResponse> findById(@PathVariable Long id) {
        UploadFileVO vo = uploadFileService.findById(id);UploadFileResponse response = UploadFileMapper.INSTANCE.vo2CustomResponse(vo);return JsonResult.success(response);
    }
    ...
    public JsonResult<PageResult<UploadFileResponse>> page(
