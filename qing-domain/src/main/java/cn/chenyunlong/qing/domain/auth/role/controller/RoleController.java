...
public class RoleController {
     ...
     */
    @PostMapping
    public JsonResult<Long> createRole(@RequestBody RoleCreateRequest request) {
    ...
    public JsonResult<String> updateRole(@RequestBody RoleUpdateRequest request) {
    ...
    public JsonResult<String> validRole(@PathVariable Long id) {
    ...
    public JsonResult<String> invalidRole(@PathVariable Long id) {
    ...
    public JsonResult<RoleResponse> findById(@PathVariable Long id) {
