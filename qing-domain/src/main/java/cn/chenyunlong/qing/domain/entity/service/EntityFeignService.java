...
public interface EntityFeignService {
    ...
    JsonResult<String> updateEntity(
        @RequestBody
    ...
    JsonResult<String> invalidEntity(
        @PathVariable("id")
        Long id);
    ...
    JsonResult<EntityResponse> findById(
        @PathVariable("id")
        Long id);
