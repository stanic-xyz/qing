...
package cn.chenyunlong.qing.infrastructure.utils.poi;

import cn.chenyunlong.qing.infrastructure.annotation.Excel;
import cn.chenyunlong.qing.infrastructure.annotation.Excels;
...
import cn.chenyunlong.qing.infrastructure.utils.file.FileTypeUtils;
import cn.chenyunlong.qing.infrastructure.utils.file.FileUploadUtils;
import cn.chenyunlong.qing.infrastructure.utils.file.ImageUtils;
import cn.chenyunlong.qing.infrastructure.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public ApiResult<String> exportExcel(List<T> list, String sheetName) {
     ...
     * @return 结果
     */
    public ApiResult<String> importTemplateExcel(String sheetName) {
    ...
    public void setCellVo(Object value, Excel attr, Cell cell) {
        if (Excel.ColumnType.STRING == attr.cellType()) {
            ...
            ClientAnchor anchor = new XSSFClientAnchor(0, 0, 0, 0, (short) cell.getColumnIndex(), cell
                    .getRow()
                    .getRowNum(), (short) (cell.getColumnIndex() + 1), cell.getRow().getRowNum() + 1);
            String imagePath = Convert.toStr(value);
            if (StringUtils.isNotEmpty(imagePath)) {
                byte[] data = ImageUtils.getImage(imagePath);
                getDrawingPatriarch(cell.getSheet()).createPicture(anchor, cell
                        .getSheet()
                        .getWorkbook()
                        .addPicture(data, getImageType(data)));
            }
        }
    }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = FileUploadUtils.defaultBaseDir;
