...
public class CommentController {
    ...
    public JsonObject<Long> createComment(@RequestBody CommentCreateRequest request) {
        CommentCreator creator = CommentMapper.INSTANCE.request2Dto(request);
        return JsonObject.success(commentService.createComment(creator));
    }
    ...
    public JsonObject<String> updateComment(@RequestBody CommentUpdateRequest request) {
    ...
    public JsonObject<String> validComment(@PathVariable Long id) {
    ...
    public JsonObject<String> invalidComment(@PathVariable Long id) {
    ...
    public JsonObject<CommentResponse> findById(@PathVariable Long id) {
    ...
    public JsonObject<PageResult<CommentResponse>> findByPage(
        ...
        return JsonObject.success(
                PageResult.of(
                        page.getContent().stream()
                                .map(vo -> CommentMapper.INSTANCE.vo2CustomResponse(vo))
