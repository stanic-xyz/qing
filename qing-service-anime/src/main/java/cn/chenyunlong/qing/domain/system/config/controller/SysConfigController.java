...
public class SysConfigController {
    ...
    public JsonObject<Long> createSysConfig(@RequestBody SysConfigCreateRequest request) {
        SysConfigCreator creator = SysConfigMapper.INSTANCE.request2Dto(request);
        return JsonObject.success(sysConfigService.createSysConfig(creator));
    }
    ...
    public JsonObject<String> updateSysConfig(@RequestBody SysConfigUpdateRequest request) {
    ...
    public JsonObject<String> validSysConfig(@PathVariable Long id) {
    ...
    public JsonObject<String> invalidSysConfig(@PathVariable Long id) {
    ...
    public JsonObject<SysConfigResponse> findById(@PathVariable Long id) {
    ...
    public JsonObject<PageResult<SysConfigResponse>> findByPage(
