...
public class SysJobController {
     ...
     */
    @PostMapping
    public JsonResult<Long> createSysJob(@RequestBody SysJobCreateRequest request) {
        SysJobCreator creator = SysJobMapper.INSTANCE.request2Dto(request);
        return JsonResult.success(sysJobService.createSysJob(creator));
    }
    ...
    public JsonResult<String> updateSysJob(@RequestBody SysJobUpdateRequest request) {
    ...
    public JsonResult<String> validSysJob(@PathVariable Long id) {
    ...
    public JsonResult<String> invalidSysJob(@PathVariable Long id) {
    ...
    public JsonResult<SysJobResponse> findById(@PathVariable Long id) {
    ...
    public JsonResult<PageResult<SysJobResponse>> findByPage(
        ...
        return JsonResult.success(
                PageResult.of(
                        page.getContent().stream()
                                .map(SysJobMapper.INSTANCE::vo2CustomResponse)
