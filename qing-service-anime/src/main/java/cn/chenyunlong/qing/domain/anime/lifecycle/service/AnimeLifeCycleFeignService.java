...
public interface AnimeLifeCycleFeignService {
    ...
    JsonResult<Long> createAnimeLifeCycle(@RequestBody AnimeLifeCycleCreateRequest request);

    /**
     * update request
     */
    @PostMapping("updateAnimeLifeCycle")
    JsonResult<String> updateAnimeLifeCycle(@RequestBody AnimeLifeCycleUpdateRequest request);

    /**
     * valid
     */
    @PostMapping("valid/{id}")
    JsonResult<String> validAnimeLifeCycle(@PathVariable("id") Long id);

    /**
     * invalid
     */
    @PostMapping("invalid/{id}")
    JsonResult<String> invalidAnimeLifeCycle(@PathVariable("id") Long id);

    /**
     * findById
     */
    @GetMapping("findById/{id}")
    JsonResult<AnimeLifeCycleResponse> findById(@PathVariable("id") Long id);

    /**
     * findByPage request
     */
    @PostMapping("findByPage")
    JsonResult<PageResult<AnimeLifeCycleResponse>> findByPage(
