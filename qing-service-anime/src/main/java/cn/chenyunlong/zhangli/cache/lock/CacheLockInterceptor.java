...
package cn.chenyunlong.zhangli.cache.lock;

import cn.chenyunlong.zhangli.cache.AbstractStringCacheStore;
import cn.chenyunlong.zhangli.core.exception.FrequentAccessException;
...
public class CacheLockInterceptor {
    ...
    private final static String CACHE_LOCK_PREFIX = "cache_lock_";
    ...
    @Around("@annotation(cn.chenyunlong.zhangli.cache.lock.CacheLock)")
