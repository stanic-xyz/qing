...
public record ConnectionKey(String providerId, String providerUserId) implements Serializable {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ConnectionKey(String id, String userId))) {
            return false;
        }
        boolean sameProvider = providerId.equals(id);
        return providerUserId != null ? sameProvider && providerUserId.equals(userId) : sameProvider && userId == null;
    }
