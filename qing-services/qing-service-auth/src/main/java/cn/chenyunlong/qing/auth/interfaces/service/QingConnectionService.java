package cn.chenyunlong.qing.auth.interfaces.service;//package cn.chenyunlong.qing.auth.interfaces.service;
//
//import cn.chenyunlong.qing.auth.domain.user.command.RegisterConnectionCommand;
...
//
//            RegisterConnectionCommand connectionCommand = RegisterConnectionCommand.create(Username.of(userDetails.getUsername()), qingAuthUser);
//            userService.registerConnection(connectionCommand);
//            return userDetails;
...
//
//    @Override
//    public void unbinding(String user, String providerId, String providerUserId) {
//
//    }
//
//    @Override
...
//
//    @Override
//    public MultiValueMap<String, ConnectionData> listAllConnections(String user) {
//        return null;
//    }
//}
