package cn.chenyunlong.qing.auth.domain.role;
...
public class RoleId extends EntityId<Long> implements Serializable {
     ...
     */
    private RoleId(@NonNull Long value) {
        if (value <= 0) {
    ...
    public static RoleId of(String id) {
        ...
        try {
            return new RoleId(Long.parseLong(id.trim()));
