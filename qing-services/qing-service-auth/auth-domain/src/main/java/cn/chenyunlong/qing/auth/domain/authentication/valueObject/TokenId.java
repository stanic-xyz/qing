 ...
 */
public record TokenId(@NotNull Long value) implements Identifiable<Long> {
     ...
     */
    public TokenId(@NonNull Long value) {
        if (value <= 0) {
    ...
    public static TokenId of(String id) {
        ...
        try {
            return new TokenId(Long.parseLong(id.trim()));
    ...
    public static TokenId generate() {
        return new TokenId(IdUtil.getSnowflakeNextId());
    }
