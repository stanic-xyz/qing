...
import cn.chenyunlong.qing.infrustructure.converter.AggregateIdMapper;
...
@Mapper(uses = {CustomMapper.class, DateMapper.class, AggregateIdMapper.class}, unmappedTargetPolicy = ReportingPolicy.IGNORE)
