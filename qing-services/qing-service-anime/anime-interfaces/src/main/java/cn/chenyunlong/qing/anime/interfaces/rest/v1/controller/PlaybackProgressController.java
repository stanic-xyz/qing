...
public class PlaybackProgressController {
    ...
    public ResponseEntity<List<PlaybackProgress>> getRecentWatched(
            @Parameter(description = "用户ID") @RequestParam("userId") @NotNull @Positive Long userId,
            @Parameter(description = "限制数量") @RequestParam(value = "limit", defaultValue = "10") @Positive int limit) {
    ...
    public ResponseEntity<Void> deleteProgress(
            @Parameter(description = "用户ID") @RequestParam("userId") @NotNull @Positive Long userId,
            @Parameter(description = "剧集ID") @RequestParam("episodeId") @NotNull @Positive Long episodeId) {
