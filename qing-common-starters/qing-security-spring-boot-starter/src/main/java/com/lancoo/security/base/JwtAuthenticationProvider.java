...
import com.lancoo.security.exception.ParseTokenException;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (Objects.isNull(userContextAware)) {
            ...
            try {
                ...
                throw new CustomAuthenticationException(CodeEnum.SystemError.getCode(), CodeEnum.SystemError.getOptionName());
            }
