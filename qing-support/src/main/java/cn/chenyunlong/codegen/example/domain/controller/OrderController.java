...
// Generated at: 2025-12-24T22:37:12.306727400
...
public class OrderController {
    ...
    public JsonResult<Long> createOrder(@RequestBody OrderCreateRequest request) {
        OrderCreator creator = OrderMapper.INSTANCE.request2Dto(request);return JsonResult.success(orderService.createOrder(creator));
    }
    ...
    public JsonResult<String> updateOrder(@RequestBody OrderUpdateRequest request) {
        OrderUpdater updater = OrderMapper.INSTANCE.request2Updater(request);orderService.updateOrder(updater);
    ...
    public JsonResult<String> validOrder(@PathVariable Long id) {
        orderService.validOrder(id);return JsonResult.success(CodeEnum.Success.getName());
    }
    ...
    public JsonResult<String> invalidOrder(@PathVariable Long id) {
        orderService.invalidOrder(id);return JsonResult.success(CodeEnum.Success.getName());
    }
    ...
    public JsonResult<OrderResponse> findById(@PathVariable Long id) {
        OrderVO vo = orderService.findById(id);OrderResponse response = OrderMapper.INSTANCE.vo2CustomResponse(vo);return JsonResult.success(response);
    }
