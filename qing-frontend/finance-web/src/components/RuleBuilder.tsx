            ...
            return (
                <div key={path.join('-')} className="border border-gray-200 rounded p-3 mb-2 bg-gray-50">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        {path.length > 0 && (
                            <button onClick={() => removeConditionNode(path)}
        ...
        return (
            <div key={path.join('-')}
                ...
                <select
                    ...
                    className="border border-gray-300 rounded px-2 py-1 text-sm flex-1 max-w-37.5"
                >
                ...
                <select
                    ...
                    className="border border-gray-300 rounded px-2 py-1 text-sm w-25"
                >
                ...
                {actionNode.map((action, index) => (
                    <div key={index}
                        ...
                        <select
                            ...
                            className="border border-gray-300 rounded px-2 py-1 text-sm flex-1 max-w-50"
                        >
