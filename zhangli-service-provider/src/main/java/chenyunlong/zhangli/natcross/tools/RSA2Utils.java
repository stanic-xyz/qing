package chenyunlong.zhangli.natcross.tools;
...
public class RSA2Utils {
    ...
    public static void main(String[] args) throws InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        System.out.println("公钥明文：\n" + JSON.toJSONString(rsaPublicKey));

        // 拿到私钥的字节流明文
        RSAPrivateKey rsaPrivateKey = getPrivateKey(privateKey);
        System.out.println("私钥明文：\n" + JSON.toJSONString(rsaPrivateKey));

        // 公钥加密：第一个值是要传进去的值，第二个值传公钥的字节流明文
        String encryptString = publicEncrypt("111111", rsaPublicKey);
        System.out.println("公钥加密的字符串：\n" + encryptString);

        // 私钥解密：第一个值传公钥加密后的对象，第二个值传私钥的字节流明文
        String decryptString = privateDecrypt(encryptString, rsaPrivateKey);
        System.out.println("私钥解密的字符串：\n" + decryptString);
    }
