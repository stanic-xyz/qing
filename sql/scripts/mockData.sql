...
CREATE PROCEDURE `insert_test_records`(IN years INT, IN animeCount INT)
BEGIN
    ...
    DECLARE animeId INT;
    DECLARE startYear INT DEFAULT 2022;
            ...
            BEGIN
                ...
                INSERT INTO `anime_info`(`id`, `name`, `district_name`, `cover_url`, `type_name`, `instruction`,
                    ...
                    value (animeId, concat('海贼王', animeId), '中国',
                           'https://vo-1255705827.cos.ap-guangzhou.myqcloud.com/H6eec4b52f5ed449b8583e5ab518e7849p.jpg',
                           'TV',
...
call insert_test_records(10, 100);
