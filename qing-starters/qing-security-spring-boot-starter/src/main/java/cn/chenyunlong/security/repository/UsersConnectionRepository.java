...
import cn.chenyunlong.security.exception.DuplicateConnectionException;
import cn.chenyunlong.security.exception.NoSuchConnectionException;
...
public interface UsersConnectionRepository {
     ...
     */
    ConnectionData updateConnectionByTokenId(AuthToken token);
