...
public class AuthingProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication)
        ...
        log.info("密码登录逻辑开始");
        log.info("code:{},state:{}", authingToken.getCode(), authingToken.getState());
        // 登录成功，返回登录结果
        ...
        try {
            OIDCTokenResponse accessTokenByCode = authenticationClient.getAccessTokenByCode(
                    ((AuthingToken) authentication).getCode());
