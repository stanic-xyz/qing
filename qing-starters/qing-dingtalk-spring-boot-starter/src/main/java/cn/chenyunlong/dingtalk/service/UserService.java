...
public class UserService {
    ...
    public UserInfo getUserInfo(String authCode) throws Exception {
        try {
            ...
            if (!rsp.isSuccess()) {
                log.error("UserService_getUserInfo getUserInfo failed, errorCode={}, errorMessage={}.", rsp.getErrcode(), rsp.getErrmsg());
                return null;
            }
            ...
            log.info("UserService_getUserInfo get success, userid={}, avatar={}.", userInfo.getUserId(), userInfo.getAvatar());
            return userInfo;
        } catch (Exception e) {
    ...
    private String getAvatar(String userid) throws ApiException {
        ...
        if (!userGetResponse.isSuccess()) {
            log.error("UserService_getUserInfo getAvatar failed, errorCode={}, errorMessage={}.", userGetResponse.getErrcode(), userGetResponse.getErrmsg());
            return null;
        }
