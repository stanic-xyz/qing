...
<template>
  <svg aria-hidden="true" class="iconify iconify--mdi" height="24" preserveAspectRatio="xMidYMid meet" role="img" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
